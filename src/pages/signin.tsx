...
const SigninPage: NextPageWithLayout = () => {
   ...
   return (
      <>
         <div className='w-[500px] mx-auto my-[175px]'>
            {renderSigninForm()}
            <p className='mt-[20px] text-[12px]'>最初にユーザーの役割を選択してください。</p>
            <form className='flex justify-center mt-[5px]' onChange={onChange}>
               <div className='px-5'>
                  <label className='pe-2' htmlFor="user">ユーザー</label>
                  <input type="radio" name="select_userrole" value="user" className='px-2' defaultChecked />
               </div>
               <div className='px-5'>
                  <label className='pe-2' htmlFor="company">企業</label>
                  <input type="radio" name="select_userrole" value="company" className='px-2' />
               </div>
               <div className='px-5'>
                  <label className='pe-2' htmlFor="admin">管理者</label>
