...
const EventPage: NextPageWithLayout<Props> = (props) => {
    return (
        <>
            ...
            />
            <div className='mx-auto relative mb-[20px] w-full px-[5%] lg:px-[10%] xl:px-[100px] py-[15px] font-bold text-[#404040]'>
                <div className='w-full'>
                    <p className='mb-[20px] lg:text-[20px] mt-[40px] text[16px]'>
                ...
                <div className='flex flex-wrap justify-center sm:justify-end mt-[40px]'>
                    <button className='w-[180px] mt-[5px] sm:mt-0 h-[40px] sm:me-[10px] me-0 flex items-center rounded-[50px] bg-[#ff8329] px-[30px] py-[10px] text-[12px] text-[#fff] hover:opacity-[0.5] duration-500'>
                ...
                <div className='py-[20px] border-b'>
                    <a href="http://www.google.com/calendar/event?action=TEMPLATE" target="_blank" className='text-[11px] flex items-center sm:justify-end justify-center'>
            ...
            <section className='px-[5%] xl:px-[100px]'>
                <div className='flex justify-between'>
                    <div className='lg:w-[25%] hidden lg:block mb-[10px]'>
                        ...
                        <div className='mx-auto mb-[20px] w-full border-b'>
                            ...
                            <div className='flex flex-wrap text-[13px] mb-[20px]'>
                                <p className='flex items-center pe-[10px]'>
                    ...
                    <div className='lg:w-[72%] w-full'>
                        ...
                        <p className='text-[24px] my-[15px] text-[#404040] text-center font-bold'>募集内容</p>
                        <p className='text-[15px] text-[#404040] leading-[2] mb-[40px] font-medium'>
                            本文が入ります。<br></br>
                            【既卒総合職（本社部門）/在宅勤務可/ミドル・バックへキャリアチェンジ可能/安定経営のソニーフィナンシャルグループ/福利厚生・教育・研修制度◎】<br></br><br></br>
                            ■以下の日程で休日選考会を実施致します。今後事業拡大に伴い新たなキャリアを形成できる貴重なチャンスです。是非ご応募お待ちしております。〇日時：2023年2月12日(日)〇会場：オンライン〇詳細：9:00～17:30：順次選考（※面接合格者は後日最終面接を実施）※所要時間1時間想定<br></br><br></br>
                            ■配属先について：今回は本社総合職の採用となります。総合職採用となるため将来的に部署異動があり、様々なキャリアパスが広がっております。以下想定配属先部門・業務になりますが、他部門へ打診させていただく可能性もございます。・営業統轄本部（推進・企画部門）・保険オペレーション本部（保険事務）・内部管理系部門 ・営業管理部(ライフプランナー職の人事部門) ・人事部・カスタマーセンター・共創戦略部・経営管理 ・法務・経理、運用管理 等※オファー時に想定される配属部門についてはお伝えさせて頂きます。
                        </p>
                        <p className='text-[15px] text-[#404040] font-medium leading-[2.2]'>
                        ...
                        <button className='w-[300px] mt-[5px] sm:mt-0 h-[80px] mx-auto mb-[50px] flex items-center justify-center rounded-[50px] bg-green-700 px-[20px] py-[10px] text-[20px] font-bold text-[#fff] duration-500 hover:opacity-[0.5]'>
                            <span>応募する </span>
                            <span className='flex items-center text-[10px] absolute end-[10%]'>
                                <RightOutlined />
                            </span>
                ...
                <div className='px-[10%] lg:px-[140px] py-[20px] lg:pt-[40px] lg:pb-[80px] border-t'>
                    <h4 className='text-center text-[20px] text-[#111] font-bold'>株式会社〇〇（企業名）について</h4>
                    <p className='text-[15px] text-[#404040] leading-[1.7]'>●ミッション里を楽しむ人を増やす <br></br>
                        ●活動範囲椎葉村を中心とした中山間地域<br></br>
                        ●活動内容1.自治体向け自治体様向けに地域おこし協力隊制度の運用支援や、企業誘致を含む官民連携に関するコンサルティングを提供しています。また、総合計画等の公共計画策定支援を行っています。</p>
                </div>
            </section>
            <div className='relative bg-[#fafafa] py-[40px] text-[#404040]'>
                <h4 className='font-bold text-[#111] text-[20px] text-center mt-[30px] mb-[20px]'>類似するイベント</h4>
